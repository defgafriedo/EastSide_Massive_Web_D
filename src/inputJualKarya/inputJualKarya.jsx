            ...
            <Container style={{ marginTop: '50px' }}>
                ...
                <Row>
                    <Col md={3}>
                        ...
                        <Row>
                            <Col style={{ marginTop: '10px', color:'white' }} md={20}>
                        ...
                        <Row>
                            <Card style={{ width: '18rem', backgroundColor: 'rgba(64,64,64,0.7)',color: 'white' }}>
                                <Card.Body>
                                    <Card.Title><Form.Label > Artwork Theme</Form.Label></Card.Title>
                                    <hr />
                        ...
                        <Row style={{ marginTop: '10px' }}>
                            <Card style={{ width: '18rem', backgroundColor: 'rgba(64,64,64,0.7)',color: 'white' }}>
                                <Card.Body>
                                    <Card.Title><Form.Label > Artwork Title</Form.Label></Card.Title>
                                    <hr />
                                    <Col style={{ marginTop: '10px' }} md={20}>
                                        <Form.Control type="text" placeholder="Normal text" style={{ backgroundColor: 'rgba(64,64,64,0.7)',color:'white' }} />
                                    </Col>
                        ...
                        <Row>
                            <Col>
                                <Col md={30} >
                                    ...
                                    <Card style={{ width: '5rem', backgroundColor: 'rgba(72,90,255,0.7)', fontSize: '10px' }}>
                                        <Card.Body>
                                            <Card.Title style={{ marginTop: '10px' }}><Form.Label style={{color:'white'}}> Price</Form.Label></Card.Title>
                                        </Card.Body>
                                    </Card>
