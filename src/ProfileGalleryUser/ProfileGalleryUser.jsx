...
const ProfileGalleryArtist = () => {
  ...
  const [itemShowcase, setItemShowcase] = useState([
    { image: drawing1, title: 'Lies', description: '“There’s twin line beetwen life and death. U will find justice over there.”' },
    { image: drawing1, title: 'Lies', description: '“There’s twin line beetwen life and death. U will find justice over there.”' },
    { image: drawing1, title: 'Lies', description: '“There’s twin line beetwen life and death. U will find justice over there.”' }
  ])
  ...
  return (
    <>
      <div style={{ backgroundImage: `url('${BackgroundProfileGallery}')`, backgroundSize: 'cover', backgroundRepeat: 'no-repeat', minHeight: '100vh', color: '#fff', }}>
        <Container fluid className="position-absolute bottom-0" style={{ marginTop: '50px' }}>
          <div className='mx-5'>
            <img
          ...
          <div className='mx-5 my-3'>
            <Row className='d-flex align-items-center'>
              ...
              <Col xs="auto">
                <div className="d-lg-block" style={{ height: '25px', border: '1px solid #fff' }}></div>
              </Col>
              <Col xs="auto">
      ...
      <div style={{ backgroundColor: '#000', color: '#fff', backgroundImage: `url('${BackgroundShowcase}')`, backgroundSize: 'cover', minHeight: '100vh' }}>
